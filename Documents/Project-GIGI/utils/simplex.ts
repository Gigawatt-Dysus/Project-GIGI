...
/**
 * You can pass in a random number generator function if you want to use seeded random numbers.
 *
 */
export class SimplexNoise {
  ...
  constructor(r: () => number = Math.random) {
    this.grad3 = [
      [1, 1, 0],
      [-1, 1, 0],
      [1, -1, 0],
  ...
  public noise3D(xin: number, yin: number, zin: number): number {
    ...
    // FIX: Completed the implementation of the noise3D function which was truncated, causing the missing return value error.
